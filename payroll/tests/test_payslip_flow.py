...
class TestPayslipFlow(TestPayslipBase):
    ...
    def test_00_payslip_flow(self):
        ...
        # I open Contribution Register and from there I print the Payslip
        # Lines report.
        ...
        data, data_format = self.env.ref('payroll.action_report_payslip').\
            render(richard_payslip.ids)

        # I print the payslip details report
        data, data_format = self.env.ref('payroll.payslip_details_report').\
            render(richard_payslip.ids)
        ...
        test_reports.try_report_action(
            ...
            'action_payslip_lines_contribution_register', context=context,
            our_module='payroll')
