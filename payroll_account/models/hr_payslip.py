                        ...
                        if rec.payslip_run_id:
                            ...
                            for slip in rec:
                                ...
                                currency = (
                                    ...
                                    or slip.journal_id.company_id.currency_id
                                )
                                ...
                                for line in slip.line_ids:
                                    ...
                                    if credit_account_id:
                                        ...
                                        line_ids.append(credit_line)
                                        credit_sum += (
                                            credit_line[2]["credit"]
                                            - credit_line[2]["debit"]
                                        )

                                if (
                                    currency.compare_amounts(credit_sum, debit_sum)
                                    == -1
                                ):
                                    acc_id = slip.journal_id.default_account_id.id
                                    if not acc_id:
                                    ...
                                    currency.compare_amounts(debit_sum, credit_sum)
                                    == -1
                                ):
                                    acc_id = slip.journal_id.default_account_id.id
                                    if not acc_id:
                            ...
                            nbatch_rec = -1
                            for batch_rec in batch_array:
                                nbatch_rec += 1
                                journal_id = batch_array[nbatch_rec]["journal_id"]
                                journal_date = batch_array[nbatch_rec]["date"]
                                batch_name = rec.payslip_run_id.name
                                nmove_rec = -1
                                for move_rec in batch_array[nbatch_rec]["line_ids"]:
                                    nmove_rec += 1
                                    move_line = (
                                        0,
                                        0,
                                        {
                                            "name": batch_array[nbatch_rec]["line_ids"][
                                                nmove_rec
                                            ][2]["name"],
                                            "partner_id": batch_array[nbatch_rec][
                                                "line_ids"
                                            ][nmove_rec][2]["partner_id"]
                                            if batch_array[nbatch_rec]["line_ids"][
                                                nmove_rec
                                            ][2]["partner_id"]
                                            else False,
                                            "account_id": batch_array[nbatch_rec][
                                                "line_ids"
                                            ][nmove_rec][2]["account_id"],
                                            "analytic_account_id": batch_array[
                                                nbatch_rec
                                            ]["line_ids"][nmove_rec][2][
                                                "analytic_account_id"
                                            ]
                                            if batch_array[nbatch_rec]["line_ids"][
                                                nmove_rec
                                            ][2]["analytic_account_id"]
                                            else False,
                                            "journal_id": batch_array[nbatch_rec][
                                                "line_ids"
                                            ][nmove_rec][2]["journal_id"],
                                            "date": batch_array[nbatch_rec]["line_ids"][
                                                nmove_rec
                                            ][2]["date"],
                                            "debit": batch_array[nbatch_rec][
                                                "line_ids"
                                            ][nmove_rec][2]["debit"],
                                            "credit": batch_array[nbatch_rec][
                                                "line_ids"
                                            ][nmove_rec][2]["credit"],
                                        },
                                    )
